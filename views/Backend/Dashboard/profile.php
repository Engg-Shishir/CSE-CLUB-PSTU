    ...
    <div style="width: 1000px; height: 500px;">
      <div style="width: 100%; height: 300px; display: flex;">
        <div
          ...
          <img src="<?= assets("Upload/Users/".$data["image"]) ?>" alt=""
            style="height: 200px; width: 50%; border:3px solid #f1f1f1;">
          <p style="font-size: 22px; font-weight: 600; margin-top: 5px;"><?= $data["name"] ?></p>
          <div
            style="width: 100%; display: flex; align-items: center; justify-content: center; -moz-column-gap: 15px; column-gap: 15px;">
            <a href="" style="text-decoration: none;"><i class="fa-brands fa-linkedin" style="font-size: 26px;"></i></a>
      ...
      <div style="height :200px;width :100%;padding :20px;">
        <div style="width :100%;padding :10px;">
          ...
          <p style="font-size: 18px; font-family: 'Times New Roman', Times, serif; text-align: justify;"><?= $data["bio"] ?></p>
        </div>
      </div>
    </div>
  </div>
