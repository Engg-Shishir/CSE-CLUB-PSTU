...
<head>
    ...
    <title>Blog | <?= $_SESSION["category"] ?></title>
    <!-- CSS Part -->
...
<body>
    ...
    <div class="container-fluid content">
        <div class="row titleBox">
            <div class="col-md-10">
                <h1><?= $_SESSION["category"] ?> Articles</h1>
        ...
        <div class="row searchbox">
            <div class="col-md-6 pagination">
                ...
                if (isset($_SESSION["page"]) && $_SESSION["page"] !== "") {
                    for ($i = 1; $i <= $page; $i++) {
                        if ($i == intval($_SESSION["page"])) { ?> <a
                                href="<?= url("/blog/category/" . $_SESSION["category"] . "/page/" . $i) ?>"
                                class="btn btn-default active"><?= $i ?></a>
                        <?php } else { ?> <a href="<?= url("/blog/category/" . $_SESSION["category"] . "/page/" . $i) ?>"
                    ...
                    for ($i = 1; $i <= $page; $i++) {
                        if ($i == 1) { ?> <a href="<?= url("/blog/category/" . $_SESSION["category"] . "/page/" . $i) ?>"
                                class="btn btn-default active"><?= $i ?></a>
                        <?php } else { ?> <a href="<?= url("/blog/category/" . $_SESSION["category"] . "/page/" . $i) ?>"
                                class="btn btn-default"><?= $i ?></a>
                        <?php }
